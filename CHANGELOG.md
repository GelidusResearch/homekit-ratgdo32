...
### What's Changed
* Merge upstream changes up to v3.4.3
* Add DHT22 Temperature and Humidity sensor support (GRGDO1 specific)
* Updated manifest and firmware naming for GRGDO1 hardware
